...
class _WorkoutPlanScreenState extends State<WorkoutPlanScreen> {
  ...
  final _goals = ['Build Muscle', 'Lose Weight', 'Improve Endurance', 'Stay Active'];
  final _levels = ['Beginner', 'Intermediate', 'Advanced'];
  final _areas = ['Full Body', 'Upper Body', 'Lower Body', 'Core', 'Cardio'];
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Tell us about yourself and get a personalized plan',
                    style: TextStyle(color: AppTheme.grey.withOpacity(0.7), fontSize: 12)),
              ])),
            ]),
          ),
          ...
          Wrap(spacing: 8, runSpacing: 8, children: _areas.map((a) {
            ...
            return _ChoiceChip(
              ...
              onTap: () => setState(() {
                if (selected) {
                  if (_focusAreas.length > 1) _focusAreas.remove(a);
                } else {
                  _focusAreas.add(a);
                }
              }),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(_loading ? 'Generating...' : 'Generate My Plan'),
            ),
          ),
          ...
          if (_plan != null) ...[
            Container(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('AI Advice', style: TextStyle(
                      color: AppTheme.secondary, fontSize: 13, fontWeight: FontWeight.w700)),
                  const SizedBox(height: 4),
                  Text(_plan!.aiAdvice, style: TextStyle(
                      color: AppTheme.white.withOpacity(0.85), fontSize: 13, height: 1.5)),
                ])),
              ]),
            ),
            ...
            Text(_plan!.title, style: const TextStyle(
...
class _SectionLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(label, style: const TextStyle(
        color: AppTheme.white, fontSize: 15, fontWeight: FontWeight.w700));
  }
}
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 10),
          Text(day.focus, style: TextStyle(
        ...
        ...day.exercises.map((ex) => Padding(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 10),
            Expanded(child: Text(ex.name, style: const TextStyle(
                color: AppTheme.white, fontSize: 14, fontWeight: FontWeight.w600))),
            Text('${ex.sets}×${ex.reps}',
                style: TextStyle(color: AppTheme.grey.withOpacity(0.7), fontSize: 13)),
            const SizedBox(width: 10),
            Text(ex.rest, style: TextStyle(
