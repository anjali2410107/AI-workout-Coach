          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                _NavItem(icon: Icons.auto_awesome_rounded, label: 'AI Plan',  index: 2, current: _index, onTap: _setIndex),
                _NavItem(icon: Icons.bar_chart_rounded,   label: 'Progress', index: 3, current: _index, onTap: _setIndex),
              ],
            ),
          ),
        ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, color: active ? AppTheme.primary : AppTheme.grey, size: 24),
