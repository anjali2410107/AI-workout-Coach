...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _subFade    = Tween(begin: 0.0, end: 1.0).animate(
        CurvedAnimation(parent: _textCtrl, curve: const Interval(0.5, 1.0, curve: Curves.easeOut)));
    _subSlide   = Tween(begin: const Offset(0, 0.6), end: Offset.zero).animate(
        CurvedAnimation(parent: _textCtrl, curve: const Interval(0.5, 1.0, curve: Curves.easeOutCubic)));
            ...
            Positioned(
              ...
              child: Column(children: [
                  ...
                  child: SlideTransition(
                    ...
                    child: ShaderMask(
                      ...
                      child: const Text('COACH',
                          textAlign: TextAlign.center,
                          style: TextStyle(color: Colors.white,
                              fontSize: 30, fontWeight: FontWeight.w900, letterSpacing: 10)),
                    ),
                  ),
                ),
                ...
                FadeTransition(
                  ...
                  child: SlideTransition(
                    position: _subSlide,
                    child: Text('Powered by Gemini AI · ML Pose Detection',
                        textAlign: TextAlign.center,
              ...
              child: FadeTransition(
                ...
                child: Column(children: [
                  ...
                  Text('Initializing AI Engine...',
                      style: TextStyle(color: AppTheme.grey.withOpacity(0.3),
...
class _GlowPainter extends CustomPainter {
  ...
  bool shouldRepaint(_GlowPainter old) =>
      old.pulse != pulse || old.opacity != opacity;
}